...
public class Tile : ObjectG
{
	...
	public this (ShumateTile* shumateTile, bool ownedRef = false)
	{
		...
		super(cast(GObject*)shumateTile, ownedRef);
	}
	...
	public this()
	{
		...
		this(cast(ShumateTile*) __p, true);
	}
	 ...
	 *
	 * Returns: A [class@Gdk.Paintable]
	 */
	public PaintableIF getPaintable()
	{
		auto __p = shumate_tile_get_paintable(shumateTile);
	...
	{
		shumate_tile_set_paintable(shumateTile, (paintable is null) ? null : paintable.getPaintableStruct());
	}
