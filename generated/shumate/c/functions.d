...
__gshared extern(C)
{
	...
	const(char)* shumate_file_cache_get_cache_dir(ShumateFileCache* fileCache);
	const(char)* shumate_file_cache_get_cache_key(ShumateFileCache* fileCache);
	uint shumate_file_cache_get_size_limit(ShumateFileCache* fileCache);
	...
	void shumate_file_cache_set_size_limit(ShumateFileCache* fileCache, uint sizeLimit);
	...
	void shumate_marker_layer_add_marker(ShumateMarkerLayer* layer, ShumateMarker* marker);
	...
	void shumate_marker_layer_remove_marker(ShumateMarkerLayer* layer, ShumateMarker* marker);
	...
	void shumate_marker_layer_set_selection_mode(ShumateMarkerLayer* layer, GtkSelectionMode mode);
	...
	void shumate_path_layer_add_node(ShumatePathLayer* layer, ShumateLocation* location);
	int shumate_path_layer_get_closed(ShumatePathLayer* layer);
	GList* shumate_path_layer_get_dash(ShumatePathLayer* layer);
	int shumate_path_layer_get_fill(ShumatePathLayer* layer);
	...
	int shumate_path_layer_get_stroke(ShumatePathLayer* layer);
	...
	void shumate_path_layer_insert_node(ShumatePathLayer* layer, ShumateLocation* location, uint position);
	void shumate_path_layer_remove_all(ShumatePathLayer* layer);
	void shumate_path_layer_remove_node(ShumatePathLayer* layer, ShumateLocation* location);
	void shumate_path_layer_set_closed(ShumatePathLayer* layer, int value);
	void shumate_path_layer_set_dash(ShumatePathLayer* layer, GList* dashPattern);
	void shumate_path_layer_set_fill(ShumatePathLayer* layer, int value);
	void shumate_path_layer_set_fill_color(ShumatePathLayer* layer, GdkRGBA* color);
	void shumate_path_layer_set_outline_color(ShumatePathLayer* layer, GdkRGBA* color);
	void shumate_path_layer_set_outline_width(ShumatePathLayer* layer, double value);
	void shumate_path_layer_set_stroke(ShumatePathLayer* layer, int value);
	void shumate_path_layer_set_stroke_color(ShumatePathLayer* layer, GdkRGBA* color);
	void shumate_path_layer_set_stroke_width(ShumatePathLayer* layer, double value);
