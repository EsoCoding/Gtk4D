...
shared static this()
{
	...
	Linker.link(gtk_source_completion_context_get_proposals_for_provider, "gtk_source_completion_context_get_proposals_for_provider", LIBRARY_SOURCEVIEW);
	...
	Linker.link(gtk_source_completion_context_list_providers, "gtk_source_completion_context_list_providers", LIBRARY_SOURCEVIEW);
	...
	Linker.link(gtk_source_completion_proposal_get_typed_text, "gtk_source_completion_proposal_get_typed_text", LIBRARY_SOURCEVIEW);
	...
	Linker.link(gtk_source_gutter_lines_has_any_class, "gtk_source_gutter_lines_has_any_class", LIBRARY_SOURCEVIEW);
	...
	Linker.link(gtk_source_snippet_new_parsed, "gtk_source_snippet_new_parsed", LIBRARY_SOURCEVIEW);
	...
	Linker.link(gtk_source_snippet_manager_list_all, "gtk_source_snippet_manager_list_all", LIBRARY_SOURCEVIEW);
...
__gshared extern(C)
{
	...
	int function(GtkSourceGutterLines* lines, uint line) c_gtk_source_gutter_lines_has_any_class;
	...
	GtkSourceSnippet* function(const(char)* text, GError** err) c_gtk_source_snippet_new_parsed;
...
alias c_gtk_source_completion_context_get_proposals_for_provider gtk_source_completion_context_get_proposals_for_provider;
...
alias c_gtk_source_completion_context_list_providers gtk_source_completion_context_list_providers;
...
alias c_gtk_source_completion_proposal_get_typed_text gtk_source_completion_proposal_get_typed_text;
...
alias c_gtk_source_gutter_lines_has_any_class gtk_source_gutter_lines_has_any_class;
...
alias c_gtk_source_snippet_new_parsed gtk_source_snippet_new_parsed;
...
alias c_gtk_source_snippet_manager_list_all gtk_source_snippet_manager_list_all;
