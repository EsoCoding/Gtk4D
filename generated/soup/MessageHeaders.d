...
public class MessageHeaders
{
	...
	{
		if ( ownedRef )
			soup_message_headers_unref(soupMessageHeaders);
	}
	 ...
	 */
	public MessageHeaders ref_()
	{
		auto __p = soup_message_headers_ref(soupMessageHeaders);
		...
		return ObjectG.getDObject!(MessageHeaders)(cast(SoupMessageHeaders*) __p, true);
	}
